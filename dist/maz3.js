(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/Users/mapa/Projects/maz3/node_modules/lodash/lodash.js":[function(require,module,exports){
(function (global){
/**
 * @license
...
},{}],"/Users/mapa/Projects/maz3/src/game.constants.js":[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var GAME_DEBUG = exports.GAME_DEBUG = true;
var GAME_ASSETS = exports.GAME_ASSETS = {
  map: 'assets/map.json',
  map_name: 'map',
...
var GAME_LAYERS = exports.GAME_LAYERS = ['Ground', 'Grass', 'Roads', 'Buildings', 'Signs'];
var GAME_PHYSICS = exports.GAME_PHYSICS = Phaser.Physics.P2JS;
var GAME_COLLISION_GROUPS = exports.GAME_COLLISION_GROUPS = [{
  name: 'Walls',
  addToWorld: true
}, {
  name: 'Signs',
...
var GAME_HERO_SETTINGS = exports.GAME_HERO_SETTINGS = [20, 20, GAME_ASSETS.hero_sprite_name];
var GAME_HERO_ANIMATIONS = exports.GAME_HERO_ANIMATIONS = [{
  name: 'left',
  frames: [0, 1],
  fps: 6
}, {
...
var Create = function () {
  ...
  _createClass(Create, [{
    key: 'fitWorld',
    value: function fitWorld(width, height) {
      if (this._layers) {
    ...
    value: function world() {
      ...
      var image = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'tmw_desert_spacing';
    ...
    value: function labels() {
      ...
      var _labels = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      if (!this._labels) this._labels = [];

      _labels.forEach(function (label) {
        var sign = _.find(_this2._signs, {
          name: label.text
        });
        ...
        _this2._labels.push(labelObject);
      });
    }
  }, {
    key: 'collisionGroups',
    value: function collisionGroups() {
      ...
      group.forEach(function (grp) {
        var objects = _this3.Game.physics.p2.convertCollisionObjects(_this3.Map, grp.name, grp.addToWorld);
        var index = 0;

        objects.forEach(function (obj) {
          obj.debug = !!window.GAME_DEBUG;
          obj.setCollisionGroup(_this3.BoundCollisionGroup);
          obj.collides(_this3.PlayerCollisionGroup);

          if (grp.name == 'Signs') {
            obj.name = _this3.Map.objects.Signs[index].name;
            index++;

            _this3._signs.push(obj);
          }
        });
      });
    }
...
var Hero = exports.Hero = function () {
  function Hero() {
    var Game = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window.GameInstance;
    var CreatedWorld = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _createClass(Hero, [{
    ...
    value: function create(x, y, sprite) {
      ...
      this.Game.physics.p2.setPostBroadphaseCallback(function (bodySource, bodyTarget) {
        return _this.interact(bodySource, bodyTarget);
      }, this.Game);
    ...
    value: function addAnimations() {
      ...
      collection.forEach(function (anim) {
        _this2.Hero.animations.add(anim.name, anim.frames, anim.fps, true);
      });
    }
  }, {
    key: "interact",
...
exports.HTML_BUILDER = exports.HTML_ELEMENT = exports.HTML_PARSER = undefined;
...
var HTML_PARSER = exports.HTML_PARSER = function () {
  function HTML_PARSER() {
    _classCallCheck(this, HTML_PARSER);
  }

  _createClass(HTML_PARSER, null, [{
    key: 'find_and_replace',
    value: function find_and_replace() {
      var source = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      var field = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var text = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';

      var exp = new RegExp('{' + field + '}', 'gi');
    ...
    value: function parse() {
      ...
      if (element) {
        var _ret = function () {
          ...
          var html = element.dataset.original;

          Object.keys(data).forEach(function (key, value) {
            html = _this.find_and_replace(html, key, data[key]);
          });
...
var HTML_ELEMENT = exports.HTML_ELEMENT = function () {
...
var HTML_BUILDER = function () {
  function HTML_BUILDER() {
    _classCallCheck(this, HTML_BUILDER);
  }

  _createClass(HTML_BUILDER, null, [{
    key: 'root',
    value: function root() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'div';
      var attributes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      var rootNode = new HTML_ELEMENT(type, Object.assign(attributes, {
        'data-uid': (0, _gameUtils.GUID)()
      }));
    ...
    value: function node() {
      ...
      var element = new HTML_ELEMENT(type, attributes);
    ...
    value: function content() {
      ...
      var contentNode = document.createTextNode(_content);
      if (this.parentNode) {
...
exports.HTML_BUILDER = HTML_BUILDER;

},{"./game.utils.js":"/Users/mapa/Projects/maz3/src/game.utils.js"}],"/Users/mapa/Projects/maz3/src/game.js":[function(require,module,exports){
'use strict';
...
var Game = exports.Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function resize() {
      ...
      this.GAME_INSTANCE.scale.setResizeCallback(function () {
        _this.GAME_INSTANCE.scale.setMaximum();
        cb(_this.GAME_INSTANCE.scale.width, _this.GAME_INSTANCE.scale.height);
      });
    }
  }]);
...
var Loader = exports.Loader = function () {
  ...
  _createClass(Loader, [{
    ...
    value: function sprite() {
      var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
      var source = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      var frameWidth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var frameHeight = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    ...
    key: "font",
    value: function font() {
      var fontData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
...
},{}],"/Users/mapa/Projects/maz3/src/game.modal.js":[function(require,module,exports){
'use strict';
...
var _gameHtml = require('./game.html.js');
...
var Modal = exports.Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    key: 'parseModal',
    value: function parseModal() {
      _gameHtml.HTML_PARSER.parse(this.modal, this.data);
    ...
    value: function remove() {
      var node = this.modal.parentNode;
    ...
    key: '_createOpenEvent',
    value: function _createOpenEvent() {
      var event = this._createEvent('open', {
        modal: this.modal
      });
    }
  }, {
...
},{"./game.html.js":"/Users/mapa/Projects/maz3/src/game.html.js"}],"/Users/mapa/Projects/maz3/src/game.render.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/mapa/Projects/maz3/src/game.utils.js":[function(require,module,exports){
'use strict';
...
var _gameModal = require('./game.modal.js');

var _gameHtml = require('./game.html.js');

var _gameConstants = require('./game.constants.js');
...
var Maz3 = new _game.Game({
  ...
  preload: function preload() {
    ...
    GAME_LOADER = new _gameLoader.Loader(Maz3.GAME_INSTANCE);

    GAME_LOADER.map(_gameConstants.GAME_ASSETS.map_name, _gameConstants.GAME_ASSETS.map);
    GAME_LOADER.image(_gameConstants.GAME_ASSETS.map_image_name, _gameConstants.GAME_ASSETS.map_image);
    (_GAME_LOADER = GAME_LOADER).sprite.apply(_GAME_LOADER, [_gameConstants.GAME_ASSETS.hero_sprite_name, _gameConstants.GAME_ASSETS.hero_sprite].concat(_toConsumableArray(_gameConstants.GAME_ASSETS.hero_sprite_size)));
    GAME_LOADER.font(_gameConstants.GAME_FONT);
  },
  ...
  create: function create() {
    ...
    Maz3.resize(function (width, height) {
      GAME_CREATE.fitWorld(width, height);
    });

    // Create the game world
    GAME_CREATE = new _gameCreate.Create(Maz3.GAME_INSTANCE);

    // ORDER IS IMPORTANT !!!
    GAME_CREATE.world(_gameConstants.GAME_ASSETS.map_name, _gameConstants.GAME_ASSETS.map_image_name);
    GAME_CREATE.physics(_gameConstants.GAME_PHYSICS);
    GAME_CREATE.layers(_gameConstants.GAME_LAYERS);
    GAME_CREATE.collisionGroups(_gameConstants.GAME_COLLISION_GROUPS);

    // Create the hame hero
    GAME_HERO = new _gameHero.Hero(Maz3.GAME_INSTANCE, GAME_CREATE);

    (_GAME_HERO = GAME_HERO).create.apply(_GAME_HERO, _toConsumableArray(_gameConstants.GAME_HERO_SETTINGS));
    GAME_HERO.addAnimations(_gameConstants.GAME_HERO_ANIMATIONS);
    ...
    GAME_CREATE.labels(_gameConstants.GAME_LABELS);
  },
  // All additional rendering is done here
  render: function render() {
    GAME_RENDER = new _gameRender.Render(Maz3.GAME_INSTANCE);
  }
});

// Build the Generic modal markup
var GENERIC_MODAL_HTML = _gameHtml.HTML_BUILDER.root('section', {
  class: 'modal-window'
}).node('div', { class: 'modal-wrapper' }).node('span', { class: 'modal-close' }).node('i', { class: 'close-icon' }).parent().node('div', { class: 'modal-header' }).content('{title}').parent().node('div', { class: 'modal-content' }).content('{description}');

// initialize the Home modal
var HOME_MODAL = new _gameModal.Modal(GENERIC_MODAL_HTML.clone(), {
  title: 'Home',
  description: 'Welcome to my humble house. Feel free to look around!'
});

// Build the North Valley modal markup
var NORTH_VALLEY_MODAL = new _gameModal.Modal(GENERIC_MODAL_HTML.clone(), {
  title: 'North Valley',
